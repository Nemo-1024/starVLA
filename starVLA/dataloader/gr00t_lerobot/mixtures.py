...
DATASET_NAMED_MIXTURES = {
    ...
    "robomind_franka_1rgb": [
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
    ],
    "robomind_franka_1rgb": [
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
    ],
    "robomind_franka_3rgb": [
        ("robomind_franka_3rgb", 1.0, "robomind_franka_3rgb"),
    ],
    "robomind_franka_3rgb": [
        ("robomind_franka_3rgb", 1.0, "robomind_franka_3rgb"),
    ],
    ...
    "lam_plus_human": [ 
        ...
        ("BridgeV2", 2.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("droid_1.0.1", 0.5, "droid"),
        ("AgiBot_merge", 0.1, "agibot_genie"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
        ("robomind_franka_3rgb", 1.0, "robomind_franka_3rgb"),
        ("robomind_ur_1rgb", 1.0, "robomind_ur_1rgb"),
    ...
    "pretrain": [ 
        ...
        ("robomind_ur_1rgb", 1.0, "robomind_ur_1rgb"),
        ("robomind_franka_fr3_dual", 1.0, "robomind_franka_fr3_dual"),
        # ("epic_kitchens_100_lerobot", 2.0, "human"),
        # ("EgoDex_lerobot", 0.5, "human"), 
    ],
    # Leave-one-out splits for lam_plus_human debugging.
    # Note: droid_1.0.1 and AgiBot_merge are intentionally removed from this family
    # to keep no-big-dataset diagnostics fast and consistent with node1 script.
    "lam_loo_without_libero_all": [
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
    ...
    "lam_loo_without_fractal_lerobot": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
    ...
    "lam_loo_without_robomind_agilex_3rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
    ...
    "lam_loo_without_robomind_franka_1rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    "lam_loo_without_robomind_franka_3rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    "lam_loo_without_robomind_ur_1rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    "lam_loo_without_robomind_franka_fr3_dual": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    "lam_loo_without_epic_kitchens_100_lerobot": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    # Leave-one-out splits over non-large subsets only (exclude droid + agibot).
    "lam_without_droid_agibot": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    "lam_loo_no_big_without_robomind_agilex_3rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_franka_1rgb", 1.0, "robomind_franka_1rgb"),
    ...
    "lam_loo_no_big_without_robomind_franka_1rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    "lam_loo_no_big_without_robomind_franka_3rgb": [
        ("libero_all", 1.0, "libero_franka"),
        ("BridgeV2", 1.0, "bridge"),
        ("fractal_lerobot", 1.0, "fractal"),
        ("robomind_agilex_3rgb", 1.0, "agilex"),
    ...
    # Single-source splits for lam_plus_human ablation/debugging.
    ...
    "lam_single_robomind_franka_3rgb": [
        ("robomind_franka_3rgb", 1.0, "robomind_franka_3rgb"),
    ],
    "lam_single_robomind_ur_1rgb": [
        ("robomind_ur_1rgb", 1.0, "robomind_ur_1rgb"),
    ],
    "lam_single_robomind_franka_fr3_dual": [
        ("robomind_franka_fr3_dual", 1.0, "robomind_franka_fr3_dual"),
    ],
